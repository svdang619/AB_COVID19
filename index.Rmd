...
author: "Steven Dang"
date: "Last updated on 7 October 2021"
output:
...
### Update
```{r}
valueBox(value = "4 October 2021" , caption = "Last Updated", color = "purple", icon = "fas fa-clock")
```
...
valueBox(value = prettyNum(sum(ts_confirmed_global$Confirmed_today), big.mark = ","), color = "teal", icon = "fas fa-chart-bar", caption = paste0("Confirmed Cases", "<br>", "New Cases: +", World_Cases_Diff))
```
...
valueBox(value = prettyNum(sum(ts_deaths_global$Deaths_today), big.mark = ","),icon = "fas fa-skull-crossbones", color = "red", caption = paste0("Deaths", "<br>", "New Deaths: +", World_Deaths_Diff))
```
...
```{r eval = TRUE, fig.height= 10, fig.width= 20}
