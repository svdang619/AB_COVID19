...
author: "Steven Dang"
date: "Last updated on 10 November 2021"
output:
...
valueBox(value = prettyNum(last(case_count$n), big.mark = ","), 
         caption = paste0("Daily Case Count", "", "Change: ",  prettyNum(last(case_count$Diff), big.mark = ",")), 
         color = "blue", 
...
valueBox(value = prettyNum(last(Active_cases_valuebox$Active_Cases), big.mark = ","), 
         caption = paste0("Active Cases", "", "Change: ", last(Active_cases_valuebox$Diff)), 
         color = "teal", 
...
valueBox(value = prettyNum(last(Deaths$Deaths), big.mark = ","), 
         caption = paste0("Total Death Count", "", "Change: ", prettyNum(last(Deaths$Diff), big.mark = ",")),
         color = "red",
...
valueBox(value = prettyNum(last(AB_Total_Vacc$Total_Vacc), big.mark = ","), 
         caption = paste0("Total Doses Administered", "", "Change: ", prettyNum(last(AB_Total_Vacc$Diff), big.mark = 
                                                                                      ",")),
         color = "fuchsia",
         icon = "fas fa-syringe")
```
...
valueBox(value = prettyNum(last(Lab_Pos$pos_rate)), 
         caption = paste0("Positivity Rate (%)", "", "Change: ", prettyNum(last(Lab_Pos$Diff)), "%"),  
         color = "green",
         icon = "fas fa-vial")
```
...
valueBox(value = prettyNum(last(Hosp_num$Hosp), big.mark = ","), 
         caption = paste0("Hospitalizations", "", "Change: ", prettyNum(last(Hosp_num$Diff), big.mark = ","), "",
...
valueBox(value = prettyNum(last(ICU_num$ICU_case), big.mark = ","), 
         caption = paste0("Patients in ICU", "", "Change: ", prettyNum(last(ICU_num$Diff), big.mark = ","), "",
...
leaflet(Vacc_poly) %>% addProviderTiles("Esri")%>% setView(lng = -115, lat = 55, zoom = 5) %>% 
  ...
  addPolygons(weight = 1,
              ...
              fillOpacity = 0.5,
              popup = ~paste("Name:", location, "",
                             "Population:", population, "",
                             "Total Cases:", total_cases,"",
                             "Active Cases:", active_cases, "",
                             "Total Deaths:", deaths, "",
                             "Total Dose Administered:", total_doses_administered, "",
                             "% pop with 1 dose:", percent_pop_1_plus_dose, "",
