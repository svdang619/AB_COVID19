...
author: "Steven Dang"
date: "Last updated on 6 October 2021"
output:
...
```{r eval = TRUE, fig.height= 5, fig.width= 20}
...
ts_deaths_global <- ts_deaths_global %>% select(1:4, tail(names(.),1))
...
leaflet(World_Coordinates) %>% 
  ...
  addCircleMarkers(radius = 5,
                   ...
                   popup = ~paste0("<b>Date: 4 October 2021 </b>", "<br>", 
                                 ...
                                 "<b>Confirmed Cases: </b>",prettyNum(ts_confirmed_global$Confirmed, big.mark = ",") , "<br>",
                                 "<b>Deaths: </b>", prettyNum(ts_deaths_global$Deaths, big.mark = ","))) %>%
